...
class LocationServiceImplTest {
    ...
    public void setUp() {
        ...
        location.setName(LocationEnum.BURUNDI);
    }

    @Test
    void getLocationByName_should_work() {
        Mockito.when(mockLocationRepository.findByName(LocationEnum.BURUNDI)).
                thenReturn(Optional.of(location));
        Location locationByName = locationServiceToTest.getLocationByName(LocationEnum.BURUNDI);
    ...
    void testLocationNotFound() {
        Assertions.assertThrows(
                ...
                () -> locationServiceToTest.getLocationByName(LocationEnum.BURUNDI));
    }
